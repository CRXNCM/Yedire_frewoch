            ...
            <div class="col-md-10 content">
                ...
                <div class="row mb-4">
                    <div class="col-md-4 col-sm-6 mb-3">
                        <div class="card stat-card bg-purple text-white h-100" style="background-color: #7e179e;">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                    ...
                    <div class="col-md-4 col-sm-6 mb-3">
                        <div class="card stat-card bg-orange text-white h-100" style="background-color: #ff7f00;">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 mb-4">
                        <div class="card h-100">
                            ...
                            <!-- Rest of the Recent Images card content remains the same -->
