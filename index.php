...
<html class="wide wow-animation" lang="en">
  ...
  <body>
          ...
          <div class="row row-50 justify-content-lg-center align-items-lg-center">
            <div class="col-lg-12">
              <div class="bunner-content-modern text-center">
                ...
                <p>Wesen Volunteer Charitable Development Organization</p>
                <h1 class="main-bunner-title">አንዳችን ለአንዳችን!</h1>
                <p>ወሰን የበጎ አድራጎት ልማት ድርጅት</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-9 col-lg-7 wow-outer">
            <div class="wow slideInDown">
              <h3>Our Gallery</h3>
              <p>Explore moments from our work with schools and communities across Ethiopia</p>
            </div>
          </div>
        </div>
        ...
        <div class="row no-gutters gallery-container">
          ...
          if ($gallery_result && $gallery_result->num_rows > 0) {
            while ($image = $gallery_result->fetch_assoc()) {
              $image_path = "images/{$image['school_id']}/{$image['image_name']}";
                  ...
                  <div class="gallery-image-wrapper">
                    ...
                    <div class="gallery-overlay">
                      ...
                      <div class="gallery-actions">
                        <a class="gallery-action-btn zoom-btn" 
                           href="images/<?php echo $image['school_id']; ?>/<?php echo $image['image_name']; ?>" 
                           data-title="<?php echo htmlspecialchars($image_title); ?>">
                          <i class="fa fa-search-plus"></i>
                        </a>
                        <a class="gallery-action-btn info-btn" 
                  ...
                  <div class="card h-100 shadow-sm">
                    <div class="card-body text-center p-4">
                      <?php if (!empty($testimonial['image_path'])): ?>
                        <div class="mb-4">
                          <img src="<?php echo htmlspecialchars($testimonial['image_path']); ?>" alt="<?php echo htmlspecialchars($testimonial['name']); ?>" class="rounded-circle" width="80" height="80">
                        </div>
                      <?php endif; ?>
                      ...
                      <p class="card-text font-italic mb-4">"<?php echo htmlspecialchars($testimonial['message']); ?>"</p>
                      
                      <div class="d-flex flex-column align-items-center">
                        <h5 class="card-title mb-1"><?php echo htmlspecialchars($testimonial['name']); ?></h5>
                        <?php if (!empty($testimonial['role'])): ?>
                          <p class="text-muted small"><?php echo htmlspecialchars($testimonial['role']); ?></p>
                        <?php endif; ?>
                      </div>
                    </div>
                  </div>
    ...
    <!-- Replace the stat.js with inline script that uses PHP values -->
    <script>
